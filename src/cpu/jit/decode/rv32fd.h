...
#ifndef __DECODE_RV32FD_H__
#define __DECODE_RV32FD_H__

#include <cpu/inst.h>

/* I-type */
static inline riscv_inst_t op_load_fp(uint32_t inst, riscv_ir_t *ir) {
...
/* S-type */
static inline riscv_inst_t op_store_fp(uint32_t inst, riscv_ir_t *ir) {
    ir->rs1 = decode_rs1(inst);
...
/* R4-type */
static inline riscv_inst_t op_madd(uint32_t inst, riscv_ir_t *ir) {
    ir->rd = decode_rd(inst);
    ir->rs1 = decode_rs1(inst);
    ir->rs2 = decode_rs2(inst);
...
/* R4-type */
static inline riscv_inst_t op_msub(uint32_t inst, riscv_ir_t *ir) {
    ir->rd = decode_rd(inst);
    ir->rs1 = decode_rs1(inst);
    ir->rs2 = decode_rs2(inst);
    ir->rs3 = decode_rs3(inst);
...
/* R4-type */
static inline riscv_inst_t op_nmsub(uint32_t inst, riscv_ir_t *ir) {
    ir->rd = decode_rd(inst);
    ir->rs1 = decode_rs1(inst);
    ir->rs2 = decode_rs2(inst);
    ir->rs3 = decode_rs3(inst);
...
/* R4-type */
static inline riscv_inst_t op_nmadd(uint32_t inst, riscv_ir_t *ir) {
    ir->rd = decode_rd(inst);
    ir->rs1 = decode_rs1(inst);
    ir->rs2 = decode_rs2(inst);
    ir->rs3 = decode_rs3(inst);
...
/* R-type */
static inline riscv_inst_t op_op_fp(uint32_t inst, riscv_ir_t *ir) {
    ir->rd = decode_rd(inst);
    ir->rs1 = decode_rs1(inst);
