...
#define CACHE_HOT        50000

typedef enum { cache_busy, cache_free } jit_cache_status;
...
#define CODE_BLOCK_INITIALIZER ((code_block_t){NULL, 0})
...
typedef branch_prop_t (*block_exec_t)(CPU_State *, EMU_State *restrict, exec_t *restrict, const jit_code_env_t *);

extern const jit_code_env_t env_wrapper;
